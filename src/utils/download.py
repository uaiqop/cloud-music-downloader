...
def write_tag(
    song_path: str, song_name: str, song_cover_url: str, singer: str, album: str
):
    ...
    try:
        ...
        audiofile.tag.images.set(
            type_=3, img_data=open("cover.jpg", "rb").read(), mime_type="image/jpeg"
        )  # 封面
